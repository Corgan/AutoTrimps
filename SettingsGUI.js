...
function initializeAllSettings() {
    ...
    createSetting('BuyBuildingsNew', ['Buy Neither', 'Buy Buildings & Storage', 'Buy Buildings', 'Buy Storage', 'AdvancedNurseries & DynamicGyms'], 'AutoBuys Storage when it is almost full (it even anticipates Jestimp) and Non-Storage Buildings (As soon as they are available). Takes cost efficiency into account before buying Non-Storage Buildings.', 'multitoggle', 1, null, "Buildings");
...
function updateCustomButtons() {
    ...
    var fuckbuilding = (bwRewardUnlocked("AutoStructure") == true && bwRewardUnlocked("DecaBuild") && getPageSetting('hidebuildings') == true && (getPageSetting('BuyBuildingsNew') == 0 || getPageSetting('BuyBuildingsNew') == 4));
